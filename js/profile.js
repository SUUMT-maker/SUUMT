    ...
    <div id="profileLevelCard" style="background: white; border: 1px solid #E7E7E7; border-radius: 32px; padding: 32px 24px 28px 24px; margin: 0 20px 32px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); transition: all 0.3s ease;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            <div style="text-align: center; padding: 16px; background: #F8F9FA; border-radius: 16px;">
                <div style="font-size: 24px; font-weight: 700; color: #3B82F6; margin-bottom: 4px;"><span id="dailyExpAmount">0</span> 숨</div>
                <div style="font-size: 14px; font-weight: 600; color: #6b7280;">총 일일미션</div>
            </div>
            <div style="text-align: center; padding: 16px; background: #F8F9FA; border-radius: 16px;">
                <div style="font-size: 24px; font-weight: 700; color: #8B5CF6; margin-bottom: 4px;"><span id="weeklyExpAmount">0</span> 숨</div>
                <div style="font-size: 14px; font-weight: 600; color: #6b7280;">총 주간챌린지</div>
            </div>
        </div>
